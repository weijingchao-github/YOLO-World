...
load_from = 'pretrained_weights/yolo_world_v2_l_clip_large_o365v1_goldg_pretrain_800ft-9df82e55.pth'
log_level = 'INFO'
...
optim_wrapper = dict(
    ...
    optimizer=dict(
        batch_size_per_gpu=16, lr=0.002, type='AdamW', weight_decay=0.0125),
    paramwise_cfg=dict(
        bias_decay_mult=0.0,
        custom_keys=dict({
