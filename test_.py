...
class_names = (
    ...
    "clock, vase, scissors, teddy bear, hair drier, toothbrush, picture, pen, light"
)
# class_names = "man with black clothes"
...
if __name__ == "__main__":
    ...
    img = run_image(runner, "demo/sample_images/3074.jpg")
    sv.plot_image(img)
