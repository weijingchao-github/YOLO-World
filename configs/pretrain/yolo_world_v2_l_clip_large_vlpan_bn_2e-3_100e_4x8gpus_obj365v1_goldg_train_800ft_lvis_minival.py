...
train_dataloader = dict(
    ...
    dataset=dict(
        _delete_=True,
        type="ConcatDataset",
        datasets=[obj365v1_train_dataset, flickr_train_dataset, mg_train_dataset],
...
coco_val_dataset = dict(
    ...
    dataset=dict(
        ...
        # data_root="/home/wjc/Storage/humanoid_head/open_source/gaze_point_select_ws/src/OVOD/scripts/YOLO-World/data/coco",
        data_root="data/coco/",
        test_mode=True,
    ...
    # class_text_path="/home/wjc/Storage/humanoid_head/open_source/gaze_point_select_ws/src/OVOD/scripts/YOLO-World/data/texts/lvis_v1_class_texts.json",
...
default_hooks = dict(
    ...
    checkpoint=dict(interval=save_epoch_intervals, rule="greater"),
)
custom_hooks = [
    dict(
        type="EMAHook",
